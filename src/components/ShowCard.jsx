...
bg-[#1a1a1a] rounded-[4px] transition-all duration-300 ease-in-out hover:shadow-xl hover:z-50 hover:scale-[1.03]
    ...
    >
      ...
      <div
        className="absolute left-0 right-0 top-full opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto
transition-opacity duration-300 ease-in-out bg-[#1a1a1a] rounded-b-xl px-2 pb-3 pt-2 z-50 shadow-[0_16px_32px_rgba(0,0,0,0.6)]
        "
      >
